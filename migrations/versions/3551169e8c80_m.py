...
def upgrade():
    ...
    with op.batch_alter_table("category", schema=None) as batch_op:
        batch_op.alter_column(
            ...
            existing_type=sa.VARCHAR(
                length=50, collation="SQL_Latin1_General_CP1_CI_AS"
            ),
    ...
    with op.batch_alter_table("user", schema=None) as batch_op:
        batch_op.alter_column(
            "username",
            existing_type=sa.VARCHAR(
                length=80, collation="SQL_Latin1_General_CP1_CI_AS"
            ),
        ...
        batch_op.alter_column(
            "email",
            existing_type=sa.VARCHAR(
                length=120, collation="SQL_Latin1_General_CP1_CI_AS"
            ),
            type_=sa.String(length=150),
            existing_nullable=False,
        )
...
def downgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "amount", sa.FLOAT(precision=53), autoincrement=False, nullable=False
        ),
        sa.Column("timestamp", sa.DATETIME(), autoincrement=False, nullable=False),
        sa.Column("user_id", sa.INTEGER(), autoincrement=False, nullable=False),
        sa.ForeignKeyConstraint(
            ["user_id"], ["user.id"], name=op.f("FK__income__user_id__6FE99F9F")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["category_id"],
            ["category.id"],
            name=op.f("FK__expense__categor__6B24EA82"),
        ),
        sa.ForeignKeyConstraint(
            ["user_id"], ["user.id"], name=op.f("FK__expense__user_id__6754599E")
        ),
